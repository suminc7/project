...
package com.greensock.data {
	...
	dynamic public class TweenMaxVars extends TweenLiteVars {
		...
		override protected function initEnumerables(nulls : Array, numbers : Array) : void {
			super.initEnumerables(nulls.concat(["onStartListener", "onUpdateListener", "onReverseCompleteListener", "onReverseCompleteParams", "onRepeat", "onRepeatParams", "startAt", "roundProps"]), numbers.concat(["repeatDelay"]));
		}
