...
package com.greensock.data {
	public class DropShadowFilterVars extends BlurFilterVars {
		...
		public static function create(vars : Object) : DropShadowFilterVars {
			...
			return new DropShadowFilterVars(vars.distance || 0, vars.blurX || 0, vars.blurY || 0, vars.alpha || 0, (vars.angle == null) ? 45 : vars.angle, (vars.color == null) ? 0x000000 : vars.color, (vars.strength == null) ? 2 : vars.strength, Boolean(vars.inner), Boolean(vars.knockout), Boolean(vars.hideObject), vars.quality || 2, vars.remove || false, (vars.index == null) ? -1 : vars.index, vars.addFilter);
		}
