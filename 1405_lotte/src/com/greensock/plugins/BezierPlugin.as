		...
		protected function init(tween : TweenLite, beziers : Array, through : Boolean) : void {
			...
			for (p in props) {
				...
				if (enumerables[p] != undefined) {
					...
					// in case TweenLite/Max hasn't reached the enumerable yet in its init() function. This prevents normal tweens from getting created for the properties that should be controled with the BezierPlugin.
				}
			}
