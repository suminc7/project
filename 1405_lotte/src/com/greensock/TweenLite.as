...
package com.greensock {
	...
	public class TweenLite extends TweenCore {
		...
		public function TweenLite(target : Object, duration : Number, vars : Object) {
			...
			propTweenLookup = {};
			_ease = defaultEase;
			// temporarily - we'll check the vars object for an ease property in the init() method. We set it to the default initially for speed purposes.
		...
		protected function init() : void {
			...
			if (prioritize) {
				...
				// reorders the linked list in order of priority. Uses a static TweenPlugin method in order to minimize file size in TweenLite
			}
