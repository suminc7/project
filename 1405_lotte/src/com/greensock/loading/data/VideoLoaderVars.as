...
package com.greensock.loading.data {
	...
	dynamic public class VideoLoaderVars extends DisplayObjectLoaderVars {
		/** @private **/
		private static var _vars : Array = ["bufferTime", "autoPlay", "smoothing", "repeat", "checkPolicyFile", "estimatedDuration", "deblocking", "bufferMode", "volume", "autoAdjustBuffer"];
		 ...
		 */
		public function VideoLoaderVars(name : String = "", estimatedBytes : uint = 0, container : DisplayObjectContainer = null, autoPlay : Boolean = true, width : Number = NaN, height : Number = NaN, scaleMode : String = "stretch", onComplete : Function = null, onProgress : Function = null, onFail : Function = null, noCache : Boolean = false, alternateURL : String = "", requireWithRoot : DisplayObject = null) {
