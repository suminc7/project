...
package com.greensock.loading.data.core {
	...
	dynamic public class LoaderItemVars extends LoaderCoreVars {
		/** @private **/
		private static var _vars : Array = ["estimatedBytes", "noCache", "alternateURL"];
		 ...
		 * @private
		 */
		public function LoaderItemVars(name : String = "", estimatedBytes : uint = 0, onComplete : Function = null, onProgress : Function = null, onFail : Function = null, noCache : Boolean = false, alternateURL : String = "", requireWithRoot : DisplayObject = null) {
