...
package com.greensock.loading.data.core {
	...
	dynamic public class LoaderCoreVars {
		/** @private **/
		private static var _vars : Array = ["name", "onComplete", "onProgress", "onFail", "requireWithRoot", "autoDispose", "onOpen", "onCancel", "onError", "onIOError", "onHTTPStatus"];
		 ...
		 * @private
		 */
		public function LoaderCoreVars(name : String = "", onComplete : Function = null, onProgress : Function = null, onFail : Function = null, requireWithRoot : DisplayObject = null) {
			_props = _vars.slice();
			this.name = name;
