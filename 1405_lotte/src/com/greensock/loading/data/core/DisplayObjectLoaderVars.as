...
package com.greensock.loading.data.core {
	...
	dynamic public class DisplayObjectLoaderVars extends LoaderItemVars {
		/** @private **/
		private static var _vars : Array = ["container", "width", "height", "centerRegistration", "scaleMode", "hAlign", "vAlign", "crop", "x", "y", "scaleX", "scaleY", "rotation", "alpha", "visible", "blendMode", "bgColor", "bgAlpha", "onSecurityError"];
		 ...
		 */
		public function DisplayObjectLoaderVars(name : String = "", estimatedBytes : uint = 0, container : DisplayObjectContainer = null, width : Number = NaN, height : Number = NaN, scaleMode : String = "stretch", onComplete : Function = null, onProgress : Function = null, onFail : Function = null, noCache : Boolean = false, alternateURL : String = "", requireWithRoot : DisplayObject = null) {
