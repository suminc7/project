...
package com.greensock.loading.data {
	...
	dynamic public class SWFLoaderVars extends DisplayObjectLoaderVars {
		/** @private **/
		private static var _vars : Array = ["context", "autoPlay", "integrateProgress", "onInit", "onChildOpen", "onChildProgress", "onChildComplete", "onChildCancel", "onChildFail"];
		 ...
		 */
		public function SWFLoaderVars(name : String = "", estimatedBytes : uint = 0, container : DisplayObjectContainer = null, autoPlay : Boolean = true, width : Number = NaN, height : Number = NaN, scaleMode : String = "stretch", onComplete : Function = null, onProgress : Function = null, onFail : Function = null, noCache : Boolean = false, alternateURL : String = "", requireWithRoot : DisplayObject = null) {
