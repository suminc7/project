	...
	public class ContentDisplay extends Sprite {
		...
		protected function _update() : void {
			...
			if (_loader.hasOwnProperty("getClass") && !_loader.scriptAccessDenied) {
				// for SWFLoaders, use loaderInfo.width/height so that everything is based on the stage size, not the bounding box of the DisplayObjects that happen to be on the stage (which could be much larger or smaller than the swf's stage)
