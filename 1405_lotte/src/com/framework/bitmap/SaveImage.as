package com.framework.bitmap {
	...
	import com.framework.types.SaveImageType;
	...
	public class SaveImage extends EventDispatcher {
		...
		public function SaveImage(url : String, obj : *, w : int = 0, h : int = 0, type : String = SaveImageType.JPG, quality : int = 100, matrix : Matrix = null) {
			...
			if (type == SaveImageType.JPG) _encoder = new JPEGEncoder(quality);
			if (type == SaveImageType.PNG) _encoder = new PNGEncoder();
			if (type == SaveImageType.BMP) _encoder = new BMPEncoder();
