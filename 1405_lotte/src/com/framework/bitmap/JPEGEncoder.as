package com.framework.bitmap {
	...
	public final class JPEGEncoder implements IEncoder {
		...
		private var std_ac_chrominance_values : Vector.<int> = Vector.<int>([]);
		...
		private function writeAPP0() : void {
			byteout.writeShort(0xFFE0);
			// marker
			byteout.writeShort(16);
			// length
			byteout.writeByte(0x4A);
			// J
			byteout.writeByte(0x46);
			// F
			byteout.writeByte(0x49);
			// I
			byteout.writeByte(0x46);
			// F
			byteout.writeByte(0);
		...
		private function writeSOF0(width : int, height : int) : void {
			byteout.writeShort(0xFFC0);
			// marker
			byteout.writeShort(17);
		...
		private function writeDQT() : void {
			byteout.writeShort(0xFFDB);
			// marker
			byteout.writeShort(132);
			// length
			byteout.writeByte(0);
		...
		private function writeDHT() : void {
			byteout.writeShort(0xFFC4);
			// marker
			byteout.writeShort(0x01A2);
			// length
		...
		private function writeSOS() : void {
			byteout.writeShort(0xFFDA);
			// marker
			byteout.writeShort(12);
			// length
			byteout.writeByte(3);
			// nrofcomponents
			byteout.writeByte(1);
