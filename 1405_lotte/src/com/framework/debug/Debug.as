...
package com.framework.debug {
	...
	public final class Debug {
		...
		public static function timerInMilliSeconds() : void {
			if (_stopWatch) Debug.tracer(_stopWatch.timeInMilliSeconds + "ms");
		}
		...
		public static function timerInSeconds() : void {
			if (_stopWatch) Debug.tracer(_stopWatch.timeInSeconds + "s");
		}
		...
		public static function timerToString() : void {
			if (_stopWatch) Debug.tracer(_stopWatch.toString());
		}
		...
		public static function timerStopToString(reset : Boolean = false) : void {
			if (_stopWatch) {
				_stopWatch.stop();
				Debug.tracer(_stopWatch.toString());
